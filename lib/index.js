...
class mcGenericMethods {
    getOAuthAccessToken(clientId, clientSecret, grantType, code, redirect_uri) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield axios_1.default // Making a GET request using axios and requesting information from the API
    ...
    getSenderDomain(mcVals) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield (0, axios_1.default)(configs)
                    .then(function (response) {
                    let senderProfileResponse = response.data;
                    var senderDomainData = "";
                    var parser = new xml2js.Parser();
                    parser.parseString(senderProfileResponse, function (err, result) {
                        senderDomainData =
                            result["soap:Envelope"]["soap:Body"][0]["RetrieveResponseMsg"][0]["Results"];
                        if (senderDomainData != undefined) {
                            let domainName = result["soap:Envelope"]["soap:Body"][0]["RetrieveResponseMsg"][0]["Results"][0]["Name"][0];
                            let sendresponse = {
